...
exports.STR = function () {
    if (this.n_equipset == 0) {
        return 114 + 259 + 7 - 70; // +7=八双 
    } else if (ws_set == 100) {
        return 114 + 323 + 7 - 70; // +7=八双
    } else {
        return 114 + 349 + 7 - 70; // +7=八双
    }
}
...
exports.DA = function () {
    if (this.n_equipset == 0) {
        return (28) + (5) + 6 + 7 + 1 + 3 + 6 + 10 + 9 + 6 + 9 - 3 
    } else if (ws_set == 100) {
...
exports.Critical = function () {
    if (this.n_equipset == 0) {
        return 13 + (5) + (10) + 10; // メリポ(5) + ギフト(10)
    } else {
        return 2 + 10 + 13 + 8 + (5) + (10) + 10; // メリポ(5)+ ギフト(10)
    }
}
